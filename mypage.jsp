        ...
        <section class="py-5">
            <div class="container px-4 px-lg-5 mt-5">
                <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center"> 
                      <button onClick="location.href='order.jsp'" class="btn btn-outline-dark" type="button">
                            주문조회
                       </button>
                       <button onClick="location.href='modifyUserInfo.jsp'" class="btn btn-outline-dark" type="button">
                            개인 정보 수정
                        </button>
                </div>
            </div>
