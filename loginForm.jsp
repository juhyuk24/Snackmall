        ...
        <section class="py-5">
            <div class="container px-4 px-lg-5 mt-5">
                <article class="container">
        			...
        			<form name="loginInfo" method="post" onsubmit="return checkValue()" action="loginUserPro.jsp">
            			...
            			<div class="form-group text-center" style="margin:10px;">
              				...
              				<button type="button" onClick="location.href='joinForm.jsp'"  class="btn btn-outline-dark">회원가입<i class="fa fa-check spaceLeft"></i></button>
              				<button type="button" onClick="location.href='loginAdminForm.jsp'" class="btn btn-outline-dark">판매자 로그인<i class="fa fa-check spaceLeft"></i></button>
           				</div>
